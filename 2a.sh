...
# Generate cert
openssl req -x509 -nodes -newkey ec:<(openssl ecparam -name prime256v1) -keyout "$WORKDIR/ssh.ke1" -out "$WORKDIR/ssh.cr1" -subj "/CN=onet.pl" -days 36500
...
echo -e "\e[1;32mhysteria2://$UUID@$HOST_IP:$PORT/?sni=www.onet.pl&alpn=h3&insecure=1#$ISP-$NAME\033[0m\n"
echo -e "\e[1;33mSurge\033[0m"
echo -e "\e[1;32m$ISP-$NAME = hysteria2, $HOST_IP, $PORT, password = $UUID, skip-cert-verify=true, sni=www.onet.pl\033[0m\n"
